      ...
      case "amazon":
        return (
          <div className="text-center mt-4 mb-4">
            <img
              alt="AmazonPay"
              src="https://d2ldlvi1yef00y.cloudfront.net/default/us/sandbox/lwa/gold/large/PwA.png"
            />
          </div>
        );
  ...
  render() {
    ...
    return (
      <div className="container-fluid payment-btn-group">
        ...
        <Button
          outline
          className={paymentSelection === "paypal" ? "active" : null}
          color="secondary"
          value="paypal"
          onClick={this.toggleContent}
        >
        ...
        <Button
          outline
          className={paymentSelection === "amazon" ? "active" : null}
          color="secondary"
          value="amazon"
          onClick={this.toggleContent}
        >
